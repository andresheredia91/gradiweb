 ...
 * Generated for Laravel 5.7.24 on 2019-01-31 23:32:50.
 *
...
namespace Styde\Html\Facades { 
    ...
    class Field {
        ...
        public static function mixin($mixin)
        {
            \Styde\Html\FieldBuilder::mixin($mixin);
        }
...
namespace Collective\Html { 
    ...
    class FormFacade {
        ...
        {
            return \Styde\Html\FormBuilder::radios($name, $options, $selected, $attributes, $hasErrors);
        }
        ...
        {
            return \Styde\Html\FormBuilder::checkboxes($name, $options, $selected, $attributes, $hasErrors);
        }
        ...
        {
            //Method inherited from \Collective\Html\FormBuilder            
            return \Styde\Html\FormBuilder::range($name, $value, $options);
        }
        ...
        {
            //Method inherited from \Collective\Html\FormBuilder            
            return \Styde\Html\FormBuilder::search($name, $value, $options);
        }
        ...
        {
            //Method inherited from \Collective\Html\FormBuilder            
            return \Styde\Html\FormBuilder::week($name, $value, $options);
        }
        ...
        {
            //Method inherited from \Collective\Html\FormBuilder            
            return \Styde\Html\FormBuilder::select($name, $list, $selected, $selectAttributes, $optionsAttributes, $optgroupsAttributes);
        }
        ...
        {
            //Method inherited from \Collective\Html\FormBuilder            
            return \Styde\Html\FormBuilder::getSelectOption($display, $value, $selected, $attributes, $optgroupAttributes);
        }
        ...
        {
            //Method inherited from \Collective\Html\FormBuilder            
            return \Styde\Html\FormBuilder::month($name, $value, $options);
        }
        ...
        {
            //Method inherited from \Collective\Html\FormBuilder            
            return \Styde\Html\FormBuilder::datalist($id, $list);
        }
        ...
        {
            //Method inherited from \Collective\Html\FormBuilder            
            return \Styde\Html\FormBuilder::considerRequest($consider);
        }
        ...
        {
            //Method inherited from \Collective\Html\FormBuilder            
            \Styde\Html\FormBuilder::mixin($mixin);
        }
    ...
    class HtmlFacade {
        ...
        {
            //Method inherited from \Collective\Html\HtmlBuilder            
            \Styde\Html\HtmlBuilder::mixin($mixin);
        }
